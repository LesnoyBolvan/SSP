        ...
        <h3><?= $message ?? ''; ?></h3>
            <form method="post" class="col-5 shadow-sm p-3 mb-5 ms-0 bg-body rounded">
                ...
                <article class="mb-3">
                    ...
                    <select class="form-select" aria-label="Выберите книгу" name="book_authors_id">
                        <?php
                ...
                <article class="mb-3">
                    ...
                    <select class="form-select" aria-label="Выберите читателя" name="user_id">
                        <?php
                ...
                <article class="mb-3">
                    ...
                    <input type="date" class="form-control" name="book_return">
                </article>
